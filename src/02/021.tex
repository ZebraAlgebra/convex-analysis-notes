...
\begin{defn}[Upward-Closed Sets, Associated Functions]
...
\paragraph{}Now we define what it means to be a convex or closed function.

\begin{defn}[Convexity and Closedness of Scalar Functions]
