...
\paragraph{}This note assumes some familiarity with point set topology, calculus, and linear algebra. Also, some contents are omitted - such as theorems on alternatives, nonconvex optimization; the interested readers are encouraged to consult \cite{bertsekas2009convex} for relevant treatments.
...
% TODO: Givn an overview of the note.
