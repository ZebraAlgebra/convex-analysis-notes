...
\begin{coro}[Strong Duality - Special Cases]\label{coro:032-reachability-special-cases}Suppose $w^\ast<\infty$.
	\begin{enumerate}[label=(\alph*)]
...
\begin{prop}[Reachability of Dual Optimal Values]\label{prop:032-reachability}
