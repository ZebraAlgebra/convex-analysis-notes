...
\begin{proof}[Proof of (f)]
	...
	\]
	where we used (f), (g) of \Cref{prop:013-yoga-recession} and \Cref{coro:015-halfspaces-intersection}. If all $E_{a,b,+}$ containing $C_1$ has vertical line, then $\{0\}\times\mathbb{R}\subset R_{\operatorname{rint}(C_1)}$, in which case $\operatorname{rint}(C_1)$ and hence $C_1$ will have a vertical line.
\end{proof}
